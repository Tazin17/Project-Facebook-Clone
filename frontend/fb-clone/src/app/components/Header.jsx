...
const Header = () => {
  ...
  return (
    ...
    variant="ghost"
    size="icon"
    className="text-gray-600 hover:text-blue-600 hover:bg-transparent md:hidden"
    onClick={toggleSidebar}
  >
    <Menu />
  </Button>
              ...
              <DropdownMenuLabel className="font-normal">
                <div className="flex flex-col space-y-1">
                  <div className="flex items-center">
                    ...
                    <div className="">
                      <p className="text-sm font-medium leadning-none">
                        Nusrat Tazin
                      </p>
                      <p className="text-xs mt-2 leadning-none">
                        nusrattazin71111@gmail.com
                      </p>
                    </div>
                  </div>
                </div>
